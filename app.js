...
(() => {
  ...
  const PROJECTS_RAW = [
...

    {
      ...
      impact: "Outcome: Multimodal airline customer service assistant designed to provide ticket pricing, booking guidance, and destination information through unified text, voice, image, and multilingual interaction.",
